...
| `esp32s3-camera-v1.4.pptx` / `.pdf` | 自己下單與組裝時對照、有電子背景的人 | 21 頁完整版：依 PCB 座標畫的零件分工圖、Economic / Standard 差異、58 顆 SMD 清單、3D 渲染、組裝尺寸與高度、四頁 3D 列印外殼（含板外零件裝配檢查與杜邦線走線）、含購買連結的採購表；2026-09-23 已更新為杜邦線版 |
