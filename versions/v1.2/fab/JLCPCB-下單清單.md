# JLCPCB PCBA 下單步驟清單 — ESP32-S3 Camera v1.2

v1.2（2026-09-21）新增電源滑動開關 SW4、EN 上拉 R21、藍色電源燈 D5 與限流 R20。SMD 共 58 顆，Extended 零件多一種（SW4 MSK12C02，C431540）。
2026-09-21 18:16 送洗前檢查後補了 J2.23、C3.2 兩顆 GND 過孔並重出 Gerber、鑽孔、CPL（見 DESIGN.md），BOM 不變。
...
- [ ] Tools → Update PCB from Schematic，確認 0 差異（2026-09-21 18:15 以 kicad-cli 驗過為 0）
- [ ] pcbnew 跑 DRC，確認 0 錯誤、0 未連接（2026-09-21 18:15 為 0/0/0；若出現任何 unconnected，不要當敷銅碎片忽略，見 DESIGN.md 第 3 節）
...
- [ ] PCB Assembly 切到 **開**
- [ ] PCBA Type（2026-09-21 決定接外接螢幕，J5、J6 想用 90° 彎針的話選 Economic 自己焊）：
  - **Standard**：連 J4（JST 座）、J5、J6（排針）一起焊，較貴；排針是直的，螢幕線要另外繞
  - **Economic**：只焊 SMD，三顆插件要自己手焊，較便宜；可自行焊 90° 彎針給螢幕線用
...
- [ ] 以下 Extended 零件都有貨：U2、U3、U4、U5、U6、Q1、Q2、J1、J2、J3、SW1–3、SW4
...
- [ ] 若選 **Economic**：把 J4、J5、J6 三行取消勾選（Do not place），之後自己焊
...
| USB-C 線 | 能傳資料的 | |
| M2 螺絲、銅柱 | 4 組 | |
| （選配）預覽螢幕 | 通用型 1.3 吋 IPS 240×240 ST7789，**7 pin 2.54 mm 焊接式**（GMT130 / ZJY133T，27.78 × 39.22 mm，四角 Ø2 孔），加 7 芯杜邦線 | 接 J5+J6，接法見 DESIGN.md 2d；要一起焊 J5、J6（建議 90° 排針）。替代：Waveshare 1.3inch LCD Module（ICShop 368031700013） |
| （Economic 才要）JST PH 2P 立式座 | 對應 J4 | |
| （Economic 才要）2.54 mm 排針 1×4 | 2 條，對應 J5、J6 | |
