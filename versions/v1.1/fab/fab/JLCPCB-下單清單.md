# JLCPCB PCBA 下單步驟清單 — ESP32-S3 Camera v1.1

日期：2026-09-18。對應檔案都在 `fab/`。
...
- [ ] Tools → Update PCB from Schematic，確認 0 差異
- [ ] pcbnew 跑 DRC，確認 0 錯誤（絲印警告與敷銅碎片提示可忽略）
...
- [ ] PCB Assembly 切到 **開**
- [ ] PCBA Type：
  - **Standard**：連 J4（JST 座）、J5、J6（排針）一起焊，較貴
  - **Economic**：只焊 SMD，三顆插件要自己手焊，較便宜
...
逐行檢查 33 行，每行都要有料號、有庫存：

- [ ] 所有電阻、電容、LED 顯示 **Basic**（不收上料費）
- [ ] 以下 Extended 零件都有貨：U2、U3、U4、U5、U6、Q1、Q2、J1、J2、J3、SW1–3
...
- [ ] **Q1、Q2 MOSFET**：三腳方向對
- [ ] **D3 SS14**：陰極線與絲印一致
- [ ] **D1、D2、D4 LED**：陰極方向對（三顆都在頂層 D1/D4，底層 D2）
- [ ] **SW1–3**：方向不影響，略過
- [ ] 電阻、電容：無極性，略過
...
- [ ] 報價明細：PCB 費、上料費（約 14 種 Extended × 一次費用）、零件費、組裝費、運費
...
- [ ] 目視：U1 天線端有沒有懸出淨空區、J2 掀蓋能開、有沒有明顯空焊
