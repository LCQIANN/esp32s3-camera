# JLCPCB PCBA 下單步驟清單 — ESP32-S3 Camera v1.4

v1.4（2026-09-22）：快門 SW3 換成側按式 ALPS SKRTLAE010（C110293，Extended）放到上板邊右段 (50.6, 2.6)，C12 下移 0.8 mm；SMD 仍 58 顆，CPL 只有這兩行不同。
...
- [ ] Tools → Update PCB from Schematic，確認 0 差異（2026-09-22 以 kicad-cli 驗過為 0）
- [ ] pcbnew 跑 DRC，確認 0 錯誤、0 未連接（2026-09-22 為 0/0/0；若出現任何 unconnected，不要當敷銅碎片忽略，見 DESIGN.md 第 3 節）
...
- [ ] 以下 Extended 零件都有貨：U2、U3、U4、U5、U6、Q1、Q2、J1、J2、J3、SW1–2、SW3（C110293 ALPS SKRTLAE010 側按式，缺貨不要換成頂按式，可換同尺寸 4.5 × 3.55 側按品並確認封裝）、SW4；Standard 方案再看 J4 C131337、J5 C225482（1×7 母座，若缺貨換任何 2.54 mm 1×7 立式母座，8.5 mm 高）
...
- [ ] **SW3 側按快門**：在上板邊右段，觸桿朝板邊外側（−y），兩個定位柱落在 Ø0.9 定位孔
...
| USB-C 線 | 能傳資料的 | |
| M2 螺絲、銅柱 | 4 組 | |
| 預覽螢幕 | 通用型 1.3 吋 IPS 240×240 ST7789，**7 pin 2.54 mm 直排針已焊**（GMT130 / ZJY133T，27.78 × 39.22 mm） | 用七條公–母杜邦線接底面 J5 母座（2026-09-23 起；也可直插）；腳序見 DESIGN.md 2d。Waveshare 版腳序不同，要用它附的線 |
